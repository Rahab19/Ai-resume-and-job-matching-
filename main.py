...
def insert_sample_data():
    ...
    # Sample courses
    sample_courses = [
        ("Python for Beginners", "Complete Python programming course", "CodeAcademy", "Programming", "Beginner", "40 hours", "https://codecademy.com/python"),
        ("Machine Learning Fundamentals", "Introduction to ML algorithms and concepts", "Coursera", "Data Science", "Intermediate", "60 hours", "https://coursera.org/ml"),
        ("React Frontend Development", "Build modern web applications with React", "Udemy", "Frontend", "Intermediate", "30 hours", "https://udemy.com/react"),
        ("AWS Cloud Essentials", "Learn cloud computing with AWS", "AWS Training", "Cloud", "Beginner", "25 hours", "https://aws.training"),
        ("UI/UX Design Principles", "Design thinking and user experience", "Design School", "Design", "Beginner", "35 hours", "https://designschool.com/ux")
    ]
